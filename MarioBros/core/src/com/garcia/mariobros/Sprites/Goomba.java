...
public class Goomba extends Enemy {
    ...
    protected void defineEnemy() {
        ...
        fdef.filter.maskBits =
                ...
                MarioBros.COIN_BIT |
                MarioBros.BRICK_BIT | MarioBros.ENEMY_BIT | MarioBros.BLANK_BIT | MarioBros.OBJECT_BIT | MarioBros.MARIO_BIT | MarioBros.ITEM_BIT; // compatible collision bits
    ...
    public void hitOnHead(Mario mario) {
        setToDestroy = true;
        MarioBros.manager.get("audio/sfx/stomp.wav", Sound.class).play();
    }
}
